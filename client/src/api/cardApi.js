 ...
 */
export function fetchCard(cardId, { signal } = {}) {
 ...
 * @returns {Promise<Card>}
 */
export function copyCard(cardId, rank) {
 ...
 */
export function reorderCard(cardId, data) {
 ...
 * @returns {Promise<Card>}
 */
export function updateCard(cardId, field, value) {
